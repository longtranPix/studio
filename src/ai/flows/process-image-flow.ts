...
const CatalogSchema = z.object({
    ...
    value: z.string().describe("The specific value of the attribute (e.g., 'Đen', 'L', 'Cổ cao'). If the value is not visible for an inferred attribute, this MUST be an empty string, not null.")
});
